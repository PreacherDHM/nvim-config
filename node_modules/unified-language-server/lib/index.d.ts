 ...
 */
export function createUnifiedLanguageServer({ ignoreName, packageField, pluginPrefix, plugins, processorName, processorSpecifier, defaultProcessor, rcName }: Options): void;
...
export type LanguageServerFields = {
     ...
     */
    defaultProcessor?: (() => import("unified").Processor<any, any, any, any>) | undefined;
};
